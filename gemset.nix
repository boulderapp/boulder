{
  ...
  oauth = {
    dependencies = ["snaky_hash" "version_gem"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0r0nbz62kibcvbcgcj719hirxkfjkxp943hrlpyn4b9crcgb2rix";
      type = "gem";
    };
    version = "0.6.2";
  };
  ...
  sorcery = {
    dependencies = ["bcrypt" "oauth" "oauth2"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0wm84fyymyvrx791rkvnx0k8b1avz2pxm5xvw7dkr8l499v188w3";
      type = "gem";
    };
    version = "0.16.4";
  };
  ...
  tailwindcss-rails = {
    ...
    source = {
      ...
      rev = "e5c406cb5005d9d4ec086bc054ea1bcce2d1ccee";
      sha256 = "0qivp1bj9fsm5ci7cx1ai9w6i4yygc1h7qrmm157c29ya1pm5nw1";
      type = "git";
      url = "https://github.com/rails/tailwindcss-rails.git";
    };
    version = "2.0.21";
  };
  thor = {
